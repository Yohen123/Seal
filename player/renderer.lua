...
function PlayerRenderer:get_draw_size()
...
function PlayerRenderer:draw_rounded_square(x, y, size, color)
    graphics.rectangle(x, y, size, size - 2, nil, nil, color)
    graphics.rectangle(x, y, size - 2, size, nil, nil, color)
end

function PlayerRenderer:get_dash_scale()
...
function PlayerRenderer:draw_core(size)
...
function PlayerRenderer:draw_dash_trail(size)
    ...
    for index = 1, 2 do
        ...
        self:draw_rounded_square(0, 0, size, color_with_alpha(self:get_color(), 0.18 * fade / index))
        love.graphics.pop()
    end
end

function PlayerRenderer:draw_aim_arrow()
